...
for h in $WORKERS
do
scp -i /home/ubuntu/.ssh/id_rsa -o StrictHostKeyChecking=no -o UserKnownHostsFile=/dev/null ${MASTER}:/home/ubuntu/hadoop-3.3.0.tgz ${h}:/home/ubuntu/hadoop-3.3.0.tgz 
echo $h
done
...
for i in ${WORKERS}
do
scp -i /home/ubuntu/.ssh/id_rsa -o StrictHostKeyChecking=no -o UserKnownHostsFile=/dev/null ${MASTER}:/home/ubuntu/spark-3.0.1-bin-hadoop3.2.tgz ${i}:/home/ubuntu/spark-3.0.1-bin-hadoop3.2.tgz
echo $i
done
